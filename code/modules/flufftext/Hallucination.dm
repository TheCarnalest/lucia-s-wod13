...
/datum/hallucination/battle/New(mob/living/carbon/C, forced = TRUE, new_battle_type)
	...
	switch(battle_type)
		...
		if("staking") //Staking + handcuff
			...
			addtimer(CALLBACK(target, /mob/.proc/playsound_local, source, 'sound/weapons/handcuffs.ogg', 15, 1), 20)
...
/datum/hallucination/sounds/New(mob/living/carbon/C, forced = TRUE, sound_type)
	...
	switch(sound_type)
		...
		if("behind")
			...
			addtimer(CALLBACK(target, /mob/.proc/playsound_local, source, 'code/modules/wod13/sounds/bumps.ogg', 30, 1), 50)
		if("sus")
		...
		if("door stuck")
			...
			addtimer(CALLBACK(target, /mob/.proc/playsound_local, source, 'code/modules/wod13/sounds/potence_activate.ogg', 50, 1), 105)
			addtimer(CALLBACK(target, /mob/.proc/playsound_local, source, 'code/modules/wod13/sounds/get_bent.ogg', 50, 1), 120)
		//Hacking a door
		if("door hack")
			target.playsound_local(source, 'code/modules/wod13/sounds/hack.ogg', 50, 1)
			addtimer(CALLBACK(target, /mob/.proc/playsound_local, source, 'sound/machines/door_open.ogg', 30, 1), rand(40, 80))
	qdel(src)
...
/datum/hallucination/weird_sounds/New(mob/living/carbon/C, forced = TRUE, sound_type)
	...
	switch(sound_type)
		...
		if("ante") //Antediluvian loose!
			...
			addtimer(CALLBACK(target, /mob/.proc/playsound_local, source, 'code/modules/wod13/sounds/mp_judgement.ogg', 65, 1), 30)
			addtimer(CALLBACK(target, /mob/.proc/playsound_local, source, 'code/modules/wod13/sounds/mp_die.ogg', 100, 1), 60)
