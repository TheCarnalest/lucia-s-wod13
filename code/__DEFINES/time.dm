...
#define ROUND_TIME(...) ( SSticker.round_start_time ? "[STATION_TIME_PASSED() > MIDNIGHT_ROLLOVER ? "[round((STATION_TIME_PASSED())/MIDNIGHT_ROLLOVER)]:[gameTimestamp(wtime = STATION_TIME_PASSED())]" : gameTimestamp(wtime = STATION_TIME_PASSED())]" : "Preround")
